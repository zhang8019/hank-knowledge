...
// tools/knowledge_read_item.ts
var name = "knowledge_read_item";
var description = "\u8BFB\u53D6\u77E5\u8BC6\u5E93\u4E2D\u67D0\u4E2A\u6750\u6599\u7684\u5B8C\u6574\u6E90\u6587\u672C\uFF08file \u8BFB raw \u526F\u672C\u3001url \u8BFB\u5DF2\u6293\u53D6\u5FEB\u7167\u3001note \u8BFB\u6B63\u6587\uFF09\u3002";
var sessionPermission = { readOnly: true };
var parameters = {
  type: "object",
  properties: {
...
async function execute(input, ctx) {
  return guard(async () => {
    ...
    const maxChars = input.maxChars && input.maxChars > 0 ? Math.min(input.maxChars, 2e5) : 2e4;
